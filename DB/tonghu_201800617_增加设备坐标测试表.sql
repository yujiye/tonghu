...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`tonghu` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `position_test` (
  ...
  `update_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '记录最后修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='地理位置测试表';
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='系统资源模块表';

/*Data for the table `resource_module` */

insert  into `resource_module`(`id`,`module_name`,`sort_num`,`pid`,`create_time`,`create_userid`,`update_time`,`update_userid`,`note`) values (1,'首页',1,0,'2018-06-15 20:31:52',1,'0000-00-00 00:00:00',NULL,'warning'),(2,'设备管理',2,0,'2018-06-15 20:32:51',1,'0000-00-00 00:00:00',NULL,'projectManage'),(3,'大屏对接',3,0,'2018-06-15 20:34:27',1,'0000-00-00 00:00:00',NULL,'dictdataManage'),(4,'事件管理',4,0,'2018-06-15 20:34:27',1,'0000-00-00 00:00:00',NULL,'anaDataManage'),(5,'用户管理',5,0,'2018-06-15 20:36:07',1,'0000-00-00 00:00:00',NULL,'userManage'),(6,'系统管理',6,0,'2018-06-15 20:36:28',1,'0000-00-00 00:00:00',NULL,'sysManage');
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='系统资源表';

/*Data for the table `resources` */

insert  into `resources`(`id`,`resource_name`,`resource_url`,`module_id`,`sort_num`,`is_restricted`,`is_menu`,`create_time`,`create_userid`,`update_time`,`update_userid`,`note`) values (1,'首页','/warning.do',1,1,0,1,'2018-06-15 20:37:00',1,'0000-00-00 00:00:00',NULL,NULL),(2,'摄像头','/projectList.do',2,1,1,1,'2018-06-15 21:07:40',1,'0000-00-00 00:00:00',NULL,NULL),(3,'门禁','/projectCreate.do',2,2,1,1,'2018-06-15 21:10:06',1,'0000-00-00 00:00:00',NULL,NULL),(4,'无人机','/projectStatInfo.do',2,3,1,1,'2018-06-15 21:12:41',1,'0000-00-00 00:00:00',NULL,NULL),(5,'单兵系统','/projectShowPass.do',2,4,1,1,'2018-06-15 21:13:48',1,'0000-00-00 00:00:00',NULL,NULL),(6,'用户管理','/userManage.do',5,1,1,1,'2018-06-15 21:21:56',1,'0000-00-00 00:00:00',NULL,NULL),(7,'查看当前用户信息','/currentUserInfo.do',5,2,0,0,'2018-06-15 21:27:25',1,'0000-00-00 00:00:00',NULL,NULL),(8,'设置当前用户信息','/setCurrentUserInfo.do ',5,3,0,0,'2018-06-15 21:28:25',1,'0000-00-00 00:00:00',NULL,NULL),(9,'修改当前用户密码','/setCurrentUserPassInfo.do',5,4,0,0,'2018-06-15 21:29:24',1,'0000-00-00 00:00:00',NULL,NULL),(10,'当前在线用户','/onlineUserList.do',5,5,1,0,'2018-06-15 21:30:11',1,'0000-00-00 00:00:00',NULL,NULL),(11,'踢掉在线用户','/shotOffOnlineUser.do ',5,6,1,0,'2018-06-15 21:35:16',1,'0000-00-00 00:00:00',NULL,NULL),(12,'日志管理','/sysLog.do',6,1,1,1,'2018-06-15 21:23:24',1,'0000-00-00 00:00:00',NULL,NULL),(13,'系统数据','/sysConfig.do',6,2,1,1,'2018-06-15 21:23:56',1,'0000-00-00 00:00:00',NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='系统角色资源关联表';

/*Data for the table `role_resource` */

insert  into `role_resource`(`id`,`role_id`,`resource_id`,`create_time`,`create_userid`,`update_time`,`update_userid`,`note`) values (1,1,2,'2018-06-15 21:43:51',1,'0000-00-00 00:00:00',NULL,NULL),(2,1,3,'2018-06-15 21:43:55',1,'0000-00-00 00:00:00',NULL,NULL),(3,1,4,'2018-06-15 21:45:14',1,'0000-00-00 00:00:00',NULL,NULL),(4,1,5,'2018-06-15 21:45:20',1,'0000-00-00 00:00:00',NULL,NULL),(5,1,6,'2018-06-15 21:45:23',1,'0000-00-00 00:00:00',NULL,NULL),(6,1,12,'2018-06-15 21:45:30',1,'0000-00-00 00:00:00',NULL,NULL),(7,1,13,'2018-06-15 21:45:38',1,'0000-00-00 00:00:00',NULL,NULL),(8,1,9,'2018-06-15 21:45:44',1,'0000-00-00 00:00:00',NULL,NULL),(9,2,2,'2018-06-15 21:45:49',1,'0000-00-00 00:00:00',NULL,NULL),(10,2,3,'2018-06-15 21:45:55',1,'0000-00-00 00:00:00',NULL,NULL),(11,2,4,'2018-06-15 21:47:45',1,'0000-00-00 00:00:00',NULL,NULL),(12,2,5,'2018-06-15 21:47:51',1,'0000-00-00 00:00:00',NULL,NULL),(13,2,12,'2018-06-15 21:47:56',1,'0000-00-00 00:00:00',NULL,NULL),(14,2,13,'2018-06-15 21:47:56',1,'0000-00-00 00:00:00',NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='系统全局配置信息表';

/*Data for the table `sys_config` */

insert  into `sys_config`(`id`,`config_item`,`config_name`,`config_value`,`value_type`,`config_note`,`create_userid`,`create_time`,`update_userid`,`update_time`) values (1,'image_file_max_size','图片大小限制（M）','10','integer','图片大小属性的最大值，单位 M',1,'2018-11-20 21:23:57',NULL,'0000-00-00 00:00:00'),(2,'front_config_file','前端大屏所需的配置文件','2','file','前端大屏所需的配置文件',1,'2018-11-20 21:23:57',NULL,'0000-00-00 00:00:00');
