...
$(function(){
	...
	$("#calendarTable").click(function(e) {$("p#vtip").remove();});
	...
	$("[reg],[url]:not([reg]),[tip]").hover(
		function(e) {
			if($(this).attr('tip') != undefined){
				...
				$('body').append( '<p id="vtip" style="font-size:14px;border:1px solid #FF0000;"><img id="vtipArrow" src="img/vtip_arrow1.png"/>' + $(this).attr('tip') + '</p>' );
